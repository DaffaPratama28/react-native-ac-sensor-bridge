 ...
 *   [2-3]   productId      uint16 (0x0387 for MJWSD05MMC-class sensors —
 *                           verify against your own captured frames)
 *   [4]     frameCounter   uint8, increments per advertisement
 *   [5-10]  mac            6 bytes, transmitted in reverse byte order
 *   [11-]   payload        plaintext object TLVs, or if isEncrypted:
...
export interface MiBeaconFrame {
  ...
  /** Raw MAC bytes in wire order (not reversed), needed verbatim for nonce/AAD construction in decrypt.ts. */
